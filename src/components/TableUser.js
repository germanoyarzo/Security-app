...
const TableUser = ({ data }) => {
  ...
  const vigiladoresCollection = collection(db2, "usuarios")
  ...
  const agregarCollection =  async ()  => {
    await setDoc(doc(db2, "usuarios", "horarios"), {
    inicio: "2022-08-30T07:00",
    finalizacion: "2022-08-30T19:00"
  })}
